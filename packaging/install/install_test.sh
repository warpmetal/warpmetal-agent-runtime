...
grep -Fq 'systemctl reload ssh.service 2>/dev/null || \' "$script"
grep -Fq 'systemctl reload sshd.service 2>/dev/null || \' "$script"
grep -Fq 'systemctl restart ssh.socket' "$script"
